      ...
      included do 
        ...
        private
          def after_action_custom_workflows
            CustomWorkflow.run_custom_workflows(:project, @project, :after_action)
          end
...
RedmineExtensions::PatchManager.register_controller_patch 'ProjectsController',
  'RedmineCustomWorkflows::Patches::ProjectsControllerPatch'