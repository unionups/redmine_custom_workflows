      ...
      included do 
        ...
        private
          def after_action_custom_workflows
            CustomWorkflow.run_custom_workflows(:version, @version, :after_action)
          end
...
RedmineExtensions::PatchManager.register_controller_patch 'VersionsController',
  'RedmineCustomWorkflows::Patches::VersionsControllerPatch'